...
class UserProfile extends React.Component {
	...
	render() {
		...
		const { name, avatar, bio, email, location, gender, date_of_birth } = this.state.userData;
					...
					<div className='profile-details'>
						<div className='profile-header'>
							...
							<div className='user-action'>
								...
								<button className='edit-button' onClick={() => this.props.history.push('/edit-profile')}>Edit profile</button>
							</div>
						</div>
						<div className='profile-info'>
							{
								(bio !== undefined && bio !== '') ?
								<p className='user-bio'>{bio}</p> : null
							}
							...
							<div className='section-list'>
								<div className='section'>
									...
									<p>{`Joined ${months[joined.getMonth()]} ${joined.getFullYear()}`}</p>
								</div>
								{
								...
								}
								{
									...
									<div className='section'>
										...
										<p>{`Born ${months[new Date(date_of_birth).getMonth()]} ${new Date(date_of_birth).getFullYear()}`}</p>
									</div> : null
								}
								{
									...
									<div className='section'>
										...
										<a href={twitter} target='_blank' rel='noopener noreferrer'>{`@${twitter.replace('https://twitter.com/', '')}`}</a>
									</div> : null
								}
								{
									...
									<div className='section'>
										...
										<a href={facebook} target='_blank' rel='noopener noreferrer'>{`@${facebook.replace('https://facebook.com/', '')}`}</a>
									</div> : null
								}
							</div>
						</div>
