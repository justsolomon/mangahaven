...
class EditProfile extends React.Component {
	...
	submitProfile = e => {
		...
		let { location, bio, date_of_birth, gender, twitter, facebook, token } = this.state;
	...
	displayUserInfo = (value) => {
		...
		if (value.social !== undefined) {
			if (value.social.twitter) twitter = value.social.twitter.replace('https://twitter.com/', '');
			if (value.social.facebook) facebook = value.social.facebook.replace('https://facebook.com/', '');
		}
	...
	render() {
		const { location, bio, date_of_birth, gender, twitter, facebook, loader, success, error } = this.state;
