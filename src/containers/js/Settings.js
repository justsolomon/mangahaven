	...
	updatePref = (key, value) => {
		localForage.getItem('userPreferences')
			.then(prefs => {
				if (prefs !== null) {
					prefs[key] = value;
					localForage.setItem('userPreferences', prefs)
		...
		return (
			<div className='settings-page'>
				...
				<div className='setting-headers'>
					...
					<Collapsible trigger='Reader' triggerTagName='div' transitionTime={250}>
						<div className='setting-options'>
					...
					<Collapsible trigger='Credits' triggerTagName='div' transitionTime={250}>
						<div className='attribution'>
							<a href='https://www.mangaeden.com' target='_blank' rel='noopener noreferrer'>
								<span>Powered by Manga Eden</span>
								<FontAwesomeIcon icon={faExternalLinkAlt} />
							</a>
							<a href="https://www.designevo.com/logo-maker/" title="Free Online Logo Maker" target='_blank' rel='noopener noreferrer'>
					...
					<Collapsible trigger='About' triggerTagName='div' transitionTime={250}>
						<div className='about-section'>
							<a href='https://github.com/solomon403/mangahaven' target='_blank' rel='noopener noreferrer'>
								<span>GitHub</span>
								<FontAwesomeIcon icon={faExternalLinkAlt} />
							</a>
						</div>
					...
					<Collapsible trigger='Feedback & Bug Reports' triggerTagName='div' transitionTime={250}>
						<div className='feedback-reports'>
							<a href='mailto:gbsolomon23@gmail.com?subject=Bug Reports & Feedback' target='_blank' rel='noopener noreferrer'>
								<span>Send an Email</span>
								<FontAwesomeIcon icon={faExternalLinkAlt} />
							</a>
							<a href='https://github.com/Solomon403/mangahaven/issues/new' target='_blank' rel='noopener noreferrer'>
